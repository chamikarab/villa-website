    ...
    <section className="relative h-[80vh] min-h-[500px] w-full overflow-hidden bg-black md:h-[92vh] md:min-h-[700px]">
      ...
      <div className="relative mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-6 text-center text-white md:px-8">
        <div className="flex w-full flex-col items-center gap-6 md:gap-10 fade-up">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-5 pt-6 sm:flex-row sm:gap-8">
            <Link
              href={ctaHref}
              className="group relative w-full px-10 py-5 text-[11px] font-bold uppercase tracking-[0.4em] text-black transition-transform active:scale-95 sm:w-auto sm:px-12"
            >
            ...
            {secondaryLabel && secondaryHref ? (
              <Link
                href={secondaryHref}
                className="group flex items-center justify-center gap-4 py-3 text-[11px] font-bold uppercase tracking-[0.4em] text-white transition-colors hover:text-[#e2d1a8]"
              >
