    ...
    <div className="bg-[#faf9f6]">
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-20 md:px-8 md:py-32">
        <div className="grid gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-20">
          <div className="space-y-10 fade-up md:space-y-12">
            ...
            <div className="pt-8 flex flex-wrap gap-6 items-center border-t border-zinc-100 md:gap-8">
              <div className="space-y-1">
                <p className="font-display text-2xl text-zinc-900 md:text-3xl">85%</p>
                <p className="text-[8px] font-bold uppercase tracking-[0.15em] text-zinc-400 md:text-[9px] md:tracking-[0.2em]">Ocean View Area</p>
              </div>
              <div className="h-8 w-[1px] bg-zinc-100" />
              <div className="space-y-1">
                <p className="font-display text-2xl text-zinc-900 md:text-3xl">24/7</p>
                <p className="text-[8px] font-bold uppercase tracking-[0.15em] text-zinc-400 md:text-[9px] md:tracking-[0.2em]">Personal Service</p>
              </div>
              <div className="h-8 w-[1px] bg-zinc-100" />
              <div className="space-y-1">
                <p className="font-display text-2xl text-zinc-900 md:text-3xl">03</p>
                <p className="text-[8px] font-bold uppercase tracking-[0.15em] text-zinc-400 md:text-[9px] md:tracking-[0.2em]">Signature Suites</p>
              </div>
            </div>
          </div>

          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[40px] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.05)] border border-[#e2d1a8]/30 fade-up [animation-delay:200ms] md:rounded-[48px]">
            <Image
      ...
      <section className="bg-white py-20 md:py-32">
        <div className="mx-auto w-full max-w-7xl px-6 md:px-8 text-center mb-16 md:mb-20">
          <p className="mb-4 text-[10px] font-bold uppercase tracking-[0.5em] text-[#c5a059] md:mb-6">Our Values</p>
          <h2 className="font-display text-3xl text-zinc-900 md:text-6xl">Philosophy of Place</h2>
        </div>
        ...
        <div className="mx-auto w-full max-w-7xl px-6 md:px-8">
          <div className="grid gap-6 md:grid-cols-3 md:gap-8">
            {[
              ...
              <div
                key={item.title}
                className="group rounded-[40px] bg-[#faf9f6] p-10 border border-zinc-100 transition-all hover:border-[#e2d1a8] hover:shadow-xl hover:shadow-zinc-200/50 fade-up md:rounded-[48px] md:p-12"
                style={{ animationDelay: `${index * 150}ms` }}
              >
                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-lg text-[#c5a059] shadow-sm transition-transform group-hover:scale-110 md:mb-8 md:h-16 md:w-16 md:text-xl">
